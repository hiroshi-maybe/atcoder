...
// $ cp-batch p_cas_card_and_takahashi | diff p_cas_card_and_takahashi.out -
// $ cargo run --bin p_cas_card_and_takahashi
...
fn main() {
    ...
    let (mut c, mut r, dir) = readln!(isize, isize, String);
    r -= 1;
    c -= 1;
    let a = readlns!([char]; 9);
