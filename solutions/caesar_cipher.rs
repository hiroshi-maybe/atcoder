...
// $ cp-batch caesar_cipher | diff caesar_cipher.out -
// $ cargo run --bin caesar_cipher
...
/// 10:04-0:10 AC
///
/// https://atcoder.jp/contests/abc232/editorial/3139
///
...
fn solve() -> bool {
    ...
    for i in 1..s.len() {
        s[i] = b'a' + (s[i] + 26 - s[0]) % 26;
        t[i] = b'a' + (t[i] + 26 - t[0]) % 26;
    }
    s[0] = 0;
    t[0] = 0;
