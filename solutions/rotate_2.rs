...
// $ cp-batch rotate_2 | diff rotate_2.out -
// $ cargo run --bin rotate_2
...
/// 9:48-9:52 AC
///
/// https://atcoder.jp/contests/abc235/editorial/3248
///
...
fn solve() -> i64 {
    ...
    let mut res = 0;
    for _ in 0..3 {
        res += 100 * (x[0] - b'0') as i64 + 10 * (x[1] - b'0') as i64 + (x[2] - b'0') as i64;
        x.rotate_left(1);
    }
