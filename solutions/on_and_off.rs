...
// $ cp-batch on_and_off | diff on_and_off.out -
// $ cargo run --bin on_and_off
...
/// 9:05-9:11 AC
///
/// https://atcoder.jp/contests/abc228/editorial/2933
///

fn solve() -> bool {
    let (s, mut t, x) = readln!(i32, i32, i32);
    if t < s {
        t += 24;
    }
    (s..t).contains(&x) || (s..t).contains(&(x + 24))
}
