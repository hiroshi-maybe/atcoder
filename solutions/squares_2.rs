...
// $ cp-batch squares_2 | diff squares_2.out -
// $ cargo run --bin squares_2

///
/// 11/16/2021
///
/// 10:15-0:30, 23:30-24:25 give up
/// 24:41 read editorial and got AC
///
/// https://atcoder.jp/contests/arc125/editorial/2498
/// https://docs.google.com/document/d/1Yq384PEooRVsmlzB103YMLWwE_JhPN8AbxZagNrF_vY/edit#bookmark=id.nfoi4bvdwqaj
///
...
fn sqrt(x: i64) -> i64 {
    ...
    let mut res = (x as f64 + 0.5).sqrt() as i64;
    while res * res < x {
        res += 1;
    }
    while res * res > x {
...
fn cnt(parity: i64, mut hb: i64) -> i64 {
    if hb % 2 != parity {
        hb -= 1;
    }
    (hb + 1) / 2
