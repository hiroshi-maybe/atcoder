...
// $ cp-batch the_majority | diff the_majority.out -
// $ cargo run --bin the_majority

///
/// 1/29/2022
///
/// 10:51-11:03 give up
/// 11:42 read solution tweet and got AC
///
/// https://docs.google.com/document/d/1Yq384PEooRVsmlzB103YMLWwE_JhPN8AbxZagNrF_vY/edit#bookmark=id.vhl33lydwuaz
/// https://twitter.com/tomerun/status/1487425616500920321
...
fn solve() -> u32 {
    ...
    let mut res = com.choose_large_n(x + k as i64 - 1, k - 1);
    for a in &a[1..] {
        res *= com.choose_large_n(a + k as i64 - 1, k - 1);
    }
