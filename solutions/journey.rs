...
/// https://youtu.be/avazOGG7OfY?t=3501
///
/// https://docs.google.com/document/d/1Yq384PEooRVsmlzB103YMLWwE_JhPN8AbxZagNrF_vY/edit#bookmark=id.fj771uctvaaf
///
...
fn solve() -> f64 {
    ...
    for i in (1..n).rev() {
        dp[i] = dp[i + 1] + n as f64 / (n as f64 - i as f64);
    }
