...
// $ cp-batch happy_new_year | diff happy_new_year.out -
// $ cargo run --bin happy_new_year
...
/// 11:21-11:29 AC
///
/// https://atcoder.jp/contests/abc234/editorial/3224
///

fn solve() -> String {
    let mut k = readln!(i64);

    let mut res = vec![];
    while k > 0 {
        res.push(if k % 2 == 1 { '2' } else { '0' });
        k /= 2;
    }
