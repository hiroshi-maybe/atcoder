...
// $ rs-cp-batch base_k | diff base_k.out -
// $ cargo run --bin base_k
...
fn to_base10(a: &Vec<char>, k: i64) -> i64 {
    let mut aa = 0;
    for &c in a {
...
fn main() {
    ...
    let k = readln!(usize);
    let (a, b) = readln!([char], [char]);

    let aa = to_base10(&a, k as i64);
    let bb = to_base10(&b, k as i64);
