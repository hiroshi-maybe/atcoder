...
// $ cp-batch loor_ceil_decomposition | diff loor_ceil_decomposition.out -
// $ cargo run --bin loor_ceil_decomposition
...
/// 10:27-10:48 AC
///
/// https://atcoder.jp/contests/arc135/editorial/3352
/// https://youtu.be/zp132lmxmF0?t=343
///

fn f(memo: &mut HashMap<i64, ModInt>, x: i64) -> ModInt {
    if x <= 4 {
    ...
    let res = f(memo, x / 2) * f(memo, (x + 1) / 2);
    memo.insert(x, res);
    res
}
