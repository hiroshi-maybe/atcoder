...
// $ cp-batch two_lucky_numbers | diff two_lucky_numbers.out -
// $ cargo run --bin two_lucky_numbers

///
/// 12/5/2021
///
/// 18:19-18:30, 21:40-22:02 AC
///
/// https://atcoder.jp/contests/arc131/editorial/3040
///
...
fn solve() -> i64 {
    ...
    //assert!(res < 10_i64.pow(18));
    assert!((res * 2).to_string().contains(&bb.to_string()));
