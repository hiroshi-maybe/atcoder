...
// $ cp-batch climbing_takahashi | diff climbing_takahashi.out -
// $ cargo run --bin climbing_takahashi
...
/// 9:52-9:57 AC
///
/// https://atcoder.jp/contests/abc235/editorial/3249
///
