...
// $ cp-batch fraction_floor_sum | diff fraction_floor_sum.out -
// $ cargo run --bin fraction_floor_sum
...
/// https://docs.google.com/document/d/1Yq384PEooRVsmlzB103YMLWwE_JhPN8AbxZagNrF_vY/edit#bookmark=id.dsinwbg43qic
///
