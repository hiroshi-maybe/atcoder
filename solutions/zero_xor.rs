...
// $ cp-batch zero_xor | diff zero_xor.out -
// $ cargo run --bin zero_xor
...
/// 21:20-22:06 AC
///
/// https://atcoder.jp/contests/arc131/editorial/3049
///
...
fn solve() -> bool {
    ...
    let tot = a.iter().fold(0, |x, &y| x ^ y);
    if a.iter().any(|&a| tot ^ a == 0) {
        true
    } else {
        n % 2 == 1
    }
