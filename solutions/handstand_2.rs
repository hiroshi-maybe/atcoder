...
// $ cp-batch handstand_2 | diff handstand_2.out -
// $ cargo run --bin handstand_2
...
/// 21:42-22:10 AC
///
/// https://atcoder.jp/contests/abc152/editorial
///

fn solve() -> i64 {
    let n = readln!(i64);
    let mut mx = vvec![0; 10; 10];
    for x in 1..=n {
        let d2 = x % 10;
        let mut d1 = x;
        /*
        ...
        mx[d1 as usize][d2 as usize] += 1;
    }

    let mut res = 0;
    for d1 in 1..10 {
        for d2 in 1..10 {
            res += mx[d1][d2] * mx[d2][d1];
        }
    }
    res
}
