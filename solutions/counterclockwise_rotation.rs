...
// $ cp-batch counterclockwise_rotation | diff counterclockwise_rotation.out -
// $ cargo run --bin counterclockwise_rotation
...
/// 16:10-17:05 AC
///
/// https://atcoder.jp/contests/abc259/editorial/4285
///

fn solve() -> Point<f64> {
    let (x, y, deg) = readln!(f64, f64, f64);
