...
// $ cp-batch bouquet | diff bouquet.out -
// $ cargo run --bin bouquet
...
fn solve() -> ModInt {
    let (n, a, b) = readln!(i64, usize, usize);

    let com = Com::<ModInt>::new(max(a, b));
    ModInt::from(2).pow(n) - 1 - com.choose_large_n(n, a) - com.choose_large_n(n, b)
}
