...
// $ cp-batch airport_bus | diff airport_bus.out -
// $ cargo run --bin airport_bus
...
fn main() {
    ...
    let (n, c, k) = readln!(usize, usize, i64);
    let mut t = readlns!(i64; n);
    t.sort_unstable();
    ...
    while l < n {
        let t0 = t[l];
        let mut r = l + 1;
        while r < n && t[r] <= t0 + k && r - l < c {
            r += 1;
        }
        //dbgln!(l, r, t0, t0 + k, t[r], r - l, c);
        res += 1;
        l = r;
    }
