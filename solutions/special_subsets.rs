...
// $ cp-batch special_subsets | diff special_subsets.out -
// $ cargo run --bin special_subsets
...
/// 11:40-12:06 AC
///
/// https://atcoder.jp/contests/arc114/editorial/904
///

fn dfs(u: usize, f: &Vec<usize>, viz: &mut Vec<usize>, c: &mut usize) {
    let v = f[u];
    match viz[u] {
        0 => {
            viz[u] = 1;
