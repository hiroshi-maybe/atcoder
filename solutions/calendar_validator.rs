...
// $ cp-batch calendar_validator | diff calendar_validator.out -
// $ cargo run --bin calendar_validator
...
/// 5:09-5:23 AC
///
/// https://atcoder.jp/contests/abc225/editorial/2845
///
