...
// $ cp-batch takahashis_secret | diff takahashis_secret.out -
// $ cargo run --bin takahashis_secret
...
/// 9:11-9:15 AC
///
/// https://atcoder.jp/contests/abc228/editorial/2941
///

fn solve() -> usize {
    let (n, x) = readln!(usize, usize1);
    let a = readln!([usize1]);
