...
// $ cp-batch coordinate_compression | diff coordinate_compression.out -
// $ cargo run --bin coordinate_compression
...
#[allow(dead_code)]
pub fn compress2<T: Ord + Clone>(a: Vec<T>) -> Vec<usize> {
    let mut aa = a.clone();
    aa.sort_unstable();
    aa.dedup();
    let mut res = vec![];
