...
// $ cp-batch Roaming | diff Roaming.out -
// $ g++ -std=c++14 -Wall -O2 -D_GLIBCXX_DEBUG -fsanitize=address Roaming.cpp && ./a.out
...
/*
 ...
 https://twitter.com/hanseilimak/status/1273292362492424192
...
void solve() {
  ModInt res=0;
  REPE(x,min(N-1,K)) res+=ModInt(choose(N-1,x))*choose(N,x);
  cout<<res<<endl;
}
