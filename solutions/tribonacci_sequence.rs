...
// $ cp-batch tribonacci_sequence | diff tribonacci_sequence.out -
// $ cargo run --bin tribonacci_sequence
...
fn f(n: usize) -> ModInt {
    let mut dp = vec![ModInt::from(0); max(n + 1, 4)];
    dp[3] = ModInt::from(1);
    for i in 4usize..=n {
...
define_modulus!(Mod10007, 10007);
pub type ModInt10007 = mod_int::ModInt<Mod10007>;
pub type ModInt = ModInt10007;
